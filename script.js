...
function determineChars(){
  ...
  //Lowercase Characters Array
    ...
    // let pwdChars = pwdChars.toString();
...
for (let i=0; i < charRemain-1; i++ ) {
  pwdChars = pwdChars + charSet[Math.floor(Math.random()*charSet.length)]
}
...
// function shuffle() {
//   while (pwdChars != 0) {
//     pwd = Math.floor(Math.random() * pwdChars);
//     pwdChars--;
//   }
// }
...
//in this big set we will randomly select characters FOR the 
